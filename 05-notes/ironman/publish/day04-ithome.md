title : [Day 04] 你其實只用了 AI 的兩種能力：一張全景圖看完它會什麼


## 大家都只常用兩個角落 — Two Corners

[Day 03](https://ithelp.ithome.com.tw/articles/10412787) 的結論是：鋸齒狀前沿看不見，你不會知道自己什麼時候踩在缺口上。
...
> **接續 Day 03：** 這就是那個「什麼時候該驗」的第一層答案：越靠左邊，越要逐項核對（它應該忠於原文，多加的就是錯）；越靠右邊，越不用（你要的就是它發揮）。
