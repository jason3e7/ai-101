...
[Day 07](https://ithelp.ithome.com.tw/articles/10415067) 的 Context Engineering 其實是第二層 (Context 管理) 加第四層 (狀態記憶) 的組合. 這一天把周圍的四層一起補上.
...
每輪自動注入, 適合放專案風格、禁止事項、你希望它每次都記得的事. [Day 07](https://ithelp.ithome.com.tw/articles/10415067) 例一那個 refactor 從三輪變一輪, 就是這件事在做.
...
每個 MCP 都吃 context (見 [Day 07](https://ithelp.ithome.com.tw/articles/10415067) 例二: 20 個 MCP 每輪多吃 5K 到 10K tokens). 挑最相關的 3 到 5 個就好. Claude Code 支援 project-level 設定, 特定 repo 才掛 GitHub MCP.
...
> **Harness 是模型的鎧甲: 你不用打造, 但要知道它有哪些關節. 認得關節, 才知道哪裡能綁、哪裡不能敲.**

明天回頭把 [Day 06](https://ithelp.ithome.com.tw/articles/10414480) 講的「有效技巧」拉一條線, 對照這三天 (Prompt / Context / Harness) 的變化, 看看**同一句「請仔細思考」在三層裡各是什麼命運**.
