---
title: AI 101 - 鐵人賽 Day 25：AI 可能會取代什麼，目前不會取代什麼
tags: [ai, 鐵人賽, ironman, 取代, 就業, 判斷力, 專業債, 草稿]
created: 2026-09-06
status: draft
---

# Day 25｜AI 可能會取代什麼，目前不會取代什麼
...
分布也很有意思：AI 使用集中在**中高薪職業**（程式設計師、資料科學家），**最低薪和最高薪兩端反而都低**。這跟 Day 24 的「中產被夾殺」，是同一件事的兩個角度。
...
判斷力不是讀來的，是**做過、做錯、被修正**累積出來的。當入門任務消失，新人一開始就沒有練習的地方。Day 24 把這個叫做**專業債（expertise debt）**。
