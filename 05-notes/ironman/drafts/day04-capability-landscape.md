...
```text
　　收斂　＜ーーーーーーーーー　轉換　ーーーーーーーーー＞　發散
　　多變少　　　　　　　　　　　等量換形式　　　　　　　　　少變多
　　ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
　　摘要　統整　　　　　　　　　翻譯　改寫　　　　　　　　　續寫　舉例
　　抽取　分類　排序　　　　　　解釋　換格式　　　　　　　　發想　替代方案
　　ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
　　必須忠於原文　　　　　　　　一樣不准加　　　　　　　　　要的就是無中生有
　　多加的就是錯　　　　　　　　最穩的一欄　　　　　　　　　亂想才是重點
```
...
**看著這張圖問自己：哪幾格我幾乎沒想過？** 那通常不是因為 AI 做不好，而是你沒想到可以這樣用。
