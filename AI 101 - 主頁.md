...
| [[AI 101 - Ollama 指令教學]] | Ollama 完整指令參考，含 context 大小確認與遠端存取 |
| [[AI 101 - 女媧 Nuwa Skill]] | 蒸餾公眾人物思維框架的 Claude Code Skill |
| [[AI 101 - Better Agent Terminal]] | 整合終端機 + Claude Agent + 開發工具的 Electron 應用 |
| [[AI 101 - 輕量模型推薦]] | 本地 LLM 模型推薦（8GB / 16GB / 32GB 分級，含 Qwen3、DeepSeek、Phi-4）|
