...
- [[AI 101 - v1 chat completions curl Cheatsheet]] — `/v1/chat/completions` 完整用法（streaming、tool use、vision）
- [[AI 101 - Ollama 指令教學]] — 本地模型，部分端點相容 OpenAI API
- [[AI 101 - vLLM]] — 高效能推論 server，相容 `/v1/chat/completions` 和 `/v1/embeddings`
