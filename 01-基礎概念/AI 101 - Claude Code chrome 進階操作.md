...
> [!info]
> 這篇是 [[AI 101 - Claude Code chrome 瀏覽器整合]] 的進階篇，專注在「開始執行瀏覽器任務之後」Claude 實際怎麼工作：工具怎麼載入、多瀏覽器怎麼選、Tab Group 怎麼管理、怎麼用 `browser_batch` 加速。
...
- [[AI 101 - Claude Code chrome 瀏覽器整合]] — 基礎安裝、架構、初始設定
- [[AI 101 - Claude Code 生態系]] — Skills、Hooks、MCP 的關係
