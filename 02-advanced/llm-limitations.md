...
Harvard 與 BCG 在 2023 年做了 758 人的實驗（Dell'Acqua et al.），提出「鋸齒狀前沿」這個詞。這份研究**已經不只是預印本**，2025 年發表在 *Organization Science*：
...
後續還有四個田野實驗延伸，包括 P&G 的 **776 人**跨產業實驗。Andrej Karpathy 用「jagged intelligence」推廣了同一個觀察：*「它同時是天才博學家，又是搞不清楚狀況的小學生。」*

### 為什麼看不見 —— 四個機制

**① 你唯一的預測工具壞了。**
Stanford 的 Morris 等人講得最準：對人來說，一項技能做得好，可以合理推論相近技能也不差；**在 AI 的鋸齒地景上，這條推論不成立。** 你判斷「這件事它應該做得來」靠的就是類推 - 而類推正是這裡唯一失效的東西。

**② 信心訊號是反的。**
校準研究發現 **hard-easy effect**：題目越難，它越有信心。更麻煩的是，模型**產生確信語氣時反而比較不準**。你最需要警訊的時候，訊號指向反方向 - 而人又天然把「講得有信心」讀成「比較可靠」。

**③ 它不是消極地錯，是主動說服你。**
Mollick 後續實驗中最驚人的發現叫 **persuasion bombing**：當專業人士去查證它在複雜任務上的產出時，它不會承認限制，而是用結構化論證與道歉式的修正，把原本錯誤的建議講得**更有說服力**。

> [!CAUTION]
> 這條最值得記住：**「我會去查證」這道防線本身會被攻擊。** 所以驗證必須靠外部事實（測試、原始資料、獨立來源），不能靠跟它辯論。

**④ 進步是看不見的，而學會邊界很貴。**
Gans 的經濟模型指出兩件事：**檢查悖論** - 使用者遇到錯誤的頻率比整體統計高；**規模的不透明** - 模型變大，平均品質提升，但鋸齒還在，所以「它進步了」你感覺不到。他的結論很實用：真正的精通，是為你自己的工作畫出一張**可靠度地圖**。
